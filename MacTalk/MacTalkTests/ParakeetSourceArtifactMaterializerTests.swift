...
final class ParakeetSourceArtifactMaterializerTests: XCTestCase {
    ...
    func test_materializeBuildsExactOfficialRequestAndWritesVerifiedBytes() async throws {
        ...
        XCTAssertEqual(requests[0].aggregateDiskBytesStillRequired, Int64(bytesA.count + bytesB.count))
        XCTAssertEqual(requests[1].aggregateDiskBytesStillRequired, Int64(bytesB.count))
